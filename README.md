...
| **Admin** | Filament panel: store and review moderation, product galleries with drag-and-drop ordering, categories, coupons, users, orders |
...
- [ ] Vendor and status-change notifications
